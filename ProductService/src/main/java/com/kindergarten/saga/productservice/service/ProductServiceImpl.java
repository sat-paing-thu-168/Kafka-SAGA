package com.kindergarten.saga.productservice.service;


import com.kindergarten.saga.core.dto.Product;
import com.kindergarten.saga.core.exceptions.ProductInsufficientQuantityException;
import com.kindergarten.saga.productservice.dao.jpa.entity.ProductEntity;
import com.kindergarten.saga.productservice.dao.jpa.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product save(Product product) {
        ...
        System.out.println("Saving product entity: " + productEntity);
        productRepository.save(productEntity);
        System.out.println("Product saved: " + productEntity.getId());
